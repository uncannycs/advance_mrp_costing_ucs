...
screenshots_start = content.find('<div aria-labelledby="screenshots-tab"')
screenshots_end = content.find('<!-- WHY UNCANNY TAB -->')

new_screenshots_tab = """<div aria-labelledby="screenshots-tab" class="tab-pane fade" id="screenshots" role="tabpanel">
                    <div class="mb-5 pt-4">
                        <h1 class="mb-5"
